...
-Express: Cria o servidor da nossa API e cuida de receber os pedidos e enviar as respostas de volta.
...
Gabriel Moreira: Foi o responsável por criar e estruturar o banco de dados do sistema utilizando o MySQL Workbench.

João Guilherme: Desenvolveu toda a parte do Back-End, configurando o servidor, a conexão com o banco e todas as rotas de usuários, corredores e voltas.

João Vitor: Trabalhou em parceria no desenvolvimento do Front-End da aplicação, cuidando do design das telas do sistema.

Isabela Scalhon: Trabalhou em parceria no desenvolvimento do Front-End da aplicação, cuidadndo da experiência do usuário e auxiliando na integração com as rotas de dados.
